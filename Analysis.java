...
public class Analysis {
	public static void main(String[] args) {
		if (args.length != 1) {
			System.err.printf("Please pass a data file (and only a data file).");
			System.exit(1);
		}
...
//		if(startDate.equals(endDate)) throw new IllegalArgumentException("Start date cannot be the same as end date!");
